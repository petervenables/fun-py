...
def test_tricky_3():
    # Additional challenge: return an empty list if there is no solution (easy version)
...
def test_challenge_4():
    # Additional challenge: return an empty list if there is no solution (hard version).
    # Note: this is challenging because of the runtime and memory constraints imposed by coderpad.
